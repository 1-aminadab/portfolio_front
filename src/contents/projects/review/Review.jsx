...
function Review() {
  ...
  return (
    <div className="projects" id="projects">
      <h1>Projects</h1>
      <p>
        Experience the perfect blend of captivating frontend, robust backend,
        and cutting-edge mobile app. Delightful user experience, seamless
        integration, and limitless possibilities await
      </p>
            ...
            <div className="sub-projects">
              {filteredData.map((project, id) => {
                ...
                return (
                  ...
                  >
                    {
                      project.hasOwnProperty('websiteLink') &&  <div
                    ...
                    >
                     ...
                     <button style={{border:"2px solid white", borderRadius:"20px"}}>Website Link</button>
                     </a>
                    </div>
                    }
                    ...
                    <div
                      ...
                      style={{
                        display: `${
                          reviewIndex === id && openReview ? "flex" : "none"
                        }`,
                      }}
                    >
                      <div
